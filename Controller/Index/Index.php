...
namespace Coditron\SearchAutoComplete\Controller\Index;
...
class Index extends \Magento\Framework\App\Action\Action
{
     ...
     * @param \Coditron\SearchAutoComplete\Helper\Data $configHelper
     */
    public function __construct(
        ...
        \Coditron\SearchAutoComplete\Helper\Data $configHelper
    ) {
    ...
    public function execute()
    {
        ...
        if ($query->getQueryText() != '') {
            ...
            $blockSearch = $this->_view->getLayout()->createBlock('Coditron\SearchAutoComplete\Block\SearchAutoComplete');
            ...
            $categoryResultsBlock = $layout
                ->createBlock('Coditron\SearchAutoComplete\Block\SearchAutoComplete')
                ->setTemplate('Coditron_SearchAutoComplete::category_results.phtml')
            ...
            $resultsBlock = $layout
                ->createBlock('Coditron\SearchAutoComplete\Block\SearchAutoComplete')
                ->setTemplate('Coditron_SearchAutoComplete::results.phtml')
